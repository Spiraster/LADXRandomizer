...
namespace LADXRandomizer
{
    public class Randomizer
    {
        ...
        private bool RandomizeWarps()
        {
            ...
            warpData.ForEach(x => x.Destination = (x.Exclude) ? x.Default : 0);
        ...
        private void CreateNewPair(Warp warp1, string name)
        {
            ...
            do
            {
                ...
                testWarp1.Destination = testWarp2.Location;
                testWarp2.Destination = testWarp1.Location;
                testWarp1_pair.Destination = testWarp2_pair.Location;
                testWarp2_pair.Destination = testWarp1_pair.Location;
            }
